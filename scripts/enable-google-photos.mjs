...
if (!photos.includes("../../utils/googlePhotosPicker")) {
...
if (!photos.includes('isGooglePhotosPicking')) {
  ...
  photos = photos.replace("  HardDrive,\n  CheckCircle2,", "  HardDrive,\n  Cloud,\n  CheckCircle2,");
...
// Repair an integration that was applied by an earlier run before the progress-modal flag was added.
if (photos.includes('const handleGooglePhotosClick') && !photos.includes("setIsGooglePhotosPicking(true);\n    setIsMounting(true);")) {
  photos = photos.replace(
    "setIsGooglePhotosPicking(true);\n    setMountProgress(2);",
    "setIsGooglePhotosPicking(true);\n    setIsMounting(true);\n    setMountProgress(2);"
  );
